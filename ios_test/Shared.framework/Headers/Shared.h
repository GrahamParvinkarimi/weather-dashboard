...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SharedSDK")))
@interface SharedSharedSDK : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sharedSDK __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSharedSDK *shared __attribute__((swift_name("shared")));
- (void)initializeAppDeclaration:(void (^)(SharedKoin_coreKoinApplication *))appDeclaration __attribute__((swift_name("initialize(appDeclaration:)")));
@end

__attribute__((swift_name("WeatherApiClient")))
@protocol SharedWeatherApiClient
@required
...
*/
- (void)getCurrentWeatherLatitude:(double)latitude longitude:(double)longitude completionHandler:(void (^)(SharedCurrentWeatherResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getCurrentWeather(latitude:longitude:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getForecastLatitude:(double)latitude longitude:(double)longitude completionHandler:(void (^)(SharedForecastResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getForecast(latitude:longitude:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchLocationsQuery:(NSString *)query limit:(int32_t)limit completionHandler:(void (^)(NSArray<SharedGeocodeResponse *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("searchLocations(query:limit:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherApiClientImpl")))
@interface SharedWeatherApiClientImpl : SharedBase <SharedWeatherApiClient>
- (instancetype)initWithHttpClient:(SharedKtor_client_coreHttpClient *)httpClient apiKey:(NSString *)apiKey __attribute__((swift_name("init(httpClient:apiKey:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWeatherApiClientImplCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherApiClientImpl.Companion")))
@interface SharedWeatherApiClientImplCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherApiClientImplCompanion *shared __attribute__((swift_name("shared")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CityResponse")))
@interface SharedCityResponse : SharedBase
- (instancetype)initWithId:(int64_t)id name:(NSString *)name coord:(SharedCoordinates *)coord country:(NSString *)country population:(SharedLong * _Nullable)population timezone:(int32_t)timezone sunrise:(int64_t)sunrise sunset:(int64_t)sunset __attribute__((swift_name("init(id:name:coord:country:population:timezone:sunrise:sunset:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCityResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedCityResponse *)doCopyId:(int64_t)id name:(NSString *)name coord:(SharedCoordinates *)coord country:(NSString *)country population:(SharedLong * _Nullable)population timezone:(int32_t)timezone sunrise:(int64_t)sunrise sunset:(int64_t)sunset __attribute__((swift_name("doCopy(id:name:coord:country:population:timezone:sunrise:sunset:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedCoordinates *coord __attribute__((swift_name("coord")));
@property (readonly) NSString *country __attribute__((swift_name("country")));
@property (readonly) int64_t id __attribute__((swift_name("id")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) SharedLong * _Nullable population __attribute__((swift_name("population")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CityResponse.Companion")))
@interface SharedCityResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCityResponseCompanion *shared __attribute__((swift_name("shared")));
...
@interface SharedCoordinates : SharedBase
...
@property (class, readonly, getter=companion) SharedCoordinatesCompanion *companion __attribute__((swift_name("companion")));
- (SharedCoordinates *)doCopyLon:(double)lon lat:(double)lat __attribute__((swift_name("doCopy(lon:lat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedCoordinatesCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCoordinatesCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrentWeatherResponse")))
@interface SharedCurrentWeatherResponse : SharedBase
- (instancetype)initWithCoord:(SharedCoordinates *)coord weather:(NSArray<SharedWeatherResponse *> *)weather main:(SharedMainResponse *)main visibility:(int32_t)visibility wind:(SharedWindResponse *)wind sys:(SharedSysResponse *)sys dt:(int64_t)dt timezone:(int32_t)timezone id:(int64_t)id name:(NSString *)name __attribute__((swift_name("init(coord:weather:main:visibility:wind:sys:dt:timezone:id:name:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCurrentWeatherResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedCurrentWeatherResponse *)doCopyCoord:(SharedCoordinates *)coord weather:(NSArray<SharedWeatherResponse *> *)weather main:(SharedMainResponse *)main visibility:(int32_t)visibility wind:(SharedWindResponse *)wind sys:(SharedSysResponse *)sys dt:(int64_t)dt timezone:(int32_t)timezone id:(int64_t)id name:(NSString *)name __attribute__((swift_name("doCopy(coord:weather:main:visibility:wind:sys:dt:timezone:id:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedCoordinates *coord __attribute__((swift_name("coord")));
...
@property (readonly) int64_t id __attribute__((swift_name("id")));
@property (readonly) SharedMainResponse *main __attribute__((swift_name("main")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) SharedSysResponse *sys __attribute__((swift_name("sys")));
@property (readonly) int32_t timezone __attribute__((swift_name("timezone")));
@property (readonly) int32_t visibility __attribute__((swift_name("visibility")));
@property (readonly) NSArray<SharedWeatherResponse *> *weather __attribute__((swift_name("weather")));
@property (readonly) SharedWindResponse *wind __attribute__((swift_name("wind")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrentWeatherResponse.Companion")))
@interface SharedCurrentWeatherResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrentWeatherResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastItemResponse")))
@interface SharedForecastItemResponse : SharedBase
- (instancetype)initWithDt:(int64_t)dt dtTxt:(NSString *)dtTxt main:(SharedMainResponse *)main weather:(NSArray<SharedWeatherResponse *> *)weather wind:(SharedWindResponse *)wind visibility:(int32_t)visibility pop:(double)pop sys:(SharedSysResponse *)sys __attribute__((swift_name("init(dt:dtTxt:main:weather:wind:visibility:pop:sys:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForecastItemResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedForecastItemResponse *)doCopyDt:(int64_t)dt dtTxt:(NSString *)dtTxt main:(SharedMainResponse *)main weather:(NSArray<SharedWeatherResponse *> *)weather wind:(SharedWindResponse *)wind visibility:(int32_t)visibility pop:(double)pop sys:(SharedSysResponse *)sys __attribute__((swift_name("doCopy(dt:dtTxt:main:weather:wind:visibility:pop:sys:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int64_t dt __attribute__((swift_name("dt")));
...
*/
@property (readonly) NSString *dtTxt __attribute__((swift_name("dtTxt")));
@property (readonly) SharedMainResponse *main __attribute__((swift_name("main")));
@property (readonly) double pop __attribute__((swift_name("pop")));
@property (readonly) SharedSysResponse *sys __attribute__((swift_name("sys")));
@property (readonly) int32_t visibility __attribute__((swift_name("visibility")));
@property (readonly) NSArray<SharedWeatherResponse *> *weather __attribute__((swift_name("weather")));
@property (readonly) SharedWindResponse *wind __attribute__((swift_name("wind")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastItemResponse.Companion")))
@interface SharedForecastItemResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForecastItemResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastResponse")))
@interface SharedForecastResponse : SharedBase
- (instancetype)initWithList:(NSArray<SharedForecastItemResponse *> *)list city:(SharedCityResponse *)city __attribute__((swift_name("init(list:city:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForecastResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedForecastResponse *)doCopyList:(NSArray<SharedForecastItemResponse *> *)list city:(SharedCityResponse *)city __attribute__((swift_name("doCopy(list:city:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedCityResponse *city __attribute__((swift_name("city")));
@property (readonly) NSArray<SharedForecastItemResponse *> *list __attribute__((swift_name("list")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastResponse.Companion")))
@interface SharedForecastResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForecastResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GeocodeResponse")))
@interface SharedGeocodeResponse : SharedBase
- (instancetype)initWithName:(NSString *)name localNames:(NSDictionary<NSString *, NSString *> * _Nullable)localNames lat:(double)lat lon:(double)lon country:(NSString *)country state:(NSString * _Nullable)state __attribute__((swift_name("init(name:localNames:lat:lon:country:state:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGeocodeResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedGeocodeResponse *)doCopyName:(NSString *)name localNames:(NSDictionary<NSString *, NSString *> * _Nullable)localNames lat:(double)lat lon:(double)lon country:(NSString *)country state:(NSString * _Nullable)state __attribute__((swift_name("doCopy(name:localNames:lat:lon:country:state:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *country __attribute__((swift_name("country")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="local_names")
*/
@property (readonly) NSDictionary<NSString *, NSString *> * _Nullable localNames __attribute__((swift_name("localNames")));
@property (readonly) double lon __attribute__((swift_name("lon")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GeocodeResponse.Companion")))
@interface SharedGeocodeResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGeocodeResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainResponse")))
@interface SharedMainResponse : SharedBase
- (instancetype)initWithTemp:(double)temp feelsLike:(double)feelsLike tempMin:(double)tempMin tempMax:(double)tempMax pressure:(double)pressure humidity:(int32_t)humidity seaLevel:(SharedDouble * _Nullable)seaLevel grndLevel:(SharedDouble * _Nullable)grndLevel __attribute__((swift_name("init(temp:feelsLike:tempMin:tempMax:pressure:humidity:seaLevel:grndLevel:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMainResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedMainResponse *)doCopyTemp:(double)temp feelsLike:(double)feelsLike tempMin:(double)tempMin tempMax:(double)tempMax pressure:(double)pressure humidity:(int32_t)humidity seaLevel:(SharedDouble * _Nullable)seaLevel grndLevel:(SharedDouble * _Nullable)grndLevel __attribute__((swift_name("doCopy(temp:feelsLike:tempMin:tempMax:pressure:humidity:seaLevel:grndLevel:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) SharedDouble * _Nullable grndLevel __attribute__((swift_name("grndLevel")));
...
*/
@property (readonly) SharedDouble * _Nullable seaLevel __attribute__((swift_name("seaLevel")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainResponse.Companion")))
@interface SharedMainResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMainResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SysResponse")))
@interface SharedSysResponse : SharedBase
- (instancetype)initWithType:(SharedInt * _Nullable)type id:(SharedInt * _Nullable)id country:(NSString * _Nullable)country sunrise:(SharedLong * _Nullable)sunrise sunset:(SharedLong * _Nullable)sunset pod:(NSString * _Nullable)pod __attribute__((swift_name("init(type:id:country:sunrise:sunset:pod:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSysResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedSysResponse *)doCopyType:(SharedInt * _Nullable)type id:(SharedInt * _Nullable)id country:(NSString * _Nullable)country sunrise:(SharedLong * _Nullable)sunrise sunset:(SharedLong * _Nullable)sunset pod:(NSString * _Nullable)pod __attribute__((swift_name("doCopy(type:id:country:sunrise:sunset:pod:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable pod __attribute__((swift_name("pod")));
@property (readonly) SharedLong * _Nullable sunrise __attribute__((swift_name("sunrise")));
@property (readonly) SharedLong * _Nullable sunset __attribute__((swift_name("sunset")));
@property (readonly) SharedInt * _Nullable type __attribute__((swift_name("type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SysResponse.Companion")))
@interface SharedSysResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSysResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedWeatherResponse : SharedBase
...
@property (class, readonly, getter=companion) SharedWeatherResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedWeatherResponse *)doCopyId:(int32_t)id main:(NSString *)main description:(NSString *)description icon:(NSString *)icon __attribute__((swift_name("doCopy(id:main:description:icon:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedWeatherResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WindResponse")))
@interface SharedWindResponse : SharedBase
- (instancetype)initWithSpeed:(double)speed deg:(int32_t)deg gust:(SharedDouble * _Nullable)gust __attribute__((swift_name("init(speed:deg:gust:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWindResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedWindResponse *)doCopySpeed:(double)speed deg:(int32_t)deg gust:(SharedDouble * _Nullable)gust __attribute__((swift_name("doCopy(speed:deg:gust:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t deg __attribute__((swift_name("deg")));
@property (readonly) SharedDouble * _Nullable gust __attribute__((swift_name("gust")));
@property (readonly) double speed __attribute__((swift_name("speed")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WindResponse.Companion")))
@interface SharedWindResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWindResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedCurrentWeather : SharedBase
- (instancetype)initWithTemperature:(double)temperature feelsLike:(double)feelsLike humidity:(int32_t)humidity pressure:(double)pressure visibility:(double)visibility uvIndex:(double)uvIndex windSpeed:(double)windSpeed windDirection:(int32_t)windDirection weatherCondition:(SharedWeatherCondition *)weatherCondition sunrise:(int64_t)sunrise sunset:(int64_t)sunset timestamp:(int64_t)timestamp __attribute__((swift_name("init(temperature:feelsLike:humidity:pressure:visibility:uvIndex:windSpeed:windDirection:weatherCondition:sunrise:sunset:timestamp:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCurrentWeatherCompanion *companion __attribute__((swift_name("companion")));
- (SharedCurrentWeather *)doCopyTemperature:(double)temperature feelsLike:(double)feelsLike humidity:(int32_t)humidity pressure:(double)pressure visibility:(double)visibility uvIndex:(double)uvIndex windSpeed:(double)windSpeed windDirection:(int32_t)windDirection weatherCondition:(SharedWeatherCondition *)weatherCondition sunrise:(int64_t)sunrise sunset:(int64_t)sunset timestamp:(int64_t)timestamp __attribute__((swift_name("doCopy(temperature:feelsLike:humidity:pressure:visibility:uvIndex:windSpeed:windDirection:weatherCondition:sunrise:sunset:timestamp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double feelsLike __attribute__((swift_name("feelsLike")));
...
@property (readonly) double uvIndex __attribute__((swift_name("uvIndex")));
@property (readonly) double visibility __attribute__((swift_name("visibility")));
@property (readonly) SharedWeatherCondition *weatherCondition __attribute__((swift_name("weatherCondition")));
...
@interface SharedCurrentWeatherCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrentWeatherCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FavoriteLocation")))
@interface SharedFavoriteLocation : SharedBase
- (instancetype)initWithLocationId:(NSString *)locationId addedAt:(int64_t)addedAt __attribute__((swift_name("init(locationId:addedAt:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFavoriteLocationCompanion *companion __attribute__((swift_name("companion")));
- (SharedFavoriteLocation *)doCopyLocationId:(NSString *)locationId addedAt:(int64_t)addedAt __attribute__((swift_name("doCopy(locationId:addedAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FavoriteLocation.Companion")))
@interface SharedFavoriteLocationCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFavoriteLocationCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedForecastItem : SharedBase
- (instancetype)initWithDate:(int64_t)date minTemperature:(double)minTemperature maxTemperature:(double)maxTemperature humidity:(int32_t)humidity windSpeed:(double)windSpeed weatherCondition:(SharedWeatherCondition *)weatherCondition precipitationProbability:(int32_t)precipitationProbability __attribute__((swift_name("init(date:minTemperature:maxTemperature:humidity:windSpeed:weatherCondition:precipitationProbability:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForecastItemCompanion *companion __attribute__((swift_name("companion")));
- (SharedForecastItem *)doCopyDate:(int64_t)date minTemperature:(double)minTemperature maxTemperature:(double)maxTemperature humidity:(int32_t)humidity windSpeed:(double)windSpeed weatherCondition:(SharedWeatherCondition *)weatherCondition precipitationProbability:(int32_t)precipitationProbability __attribute__((swift_name("doCopy(date:minTemperature:maxTemperature:humidity:windSpeed:weatherCondition:precipitationProbability:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int64_t date __attribute__((swift_name("date")));
@property (readonly) int32_t humidity __attribute__((swift_name("humidity")));
@property (readonly) double maxTemperature __attribute__((swift_name("maxTemperature")));
@property (readonly) double minTemperature __attribute__((swift_name("minTemperature")));
@property (readonly) int32_t precipitationProbability __attribute__((swift_name("precipitationProbability")));
@property (readonly) SharedWeatherCondition *weatherCondition __attribute__((swift_name("weatherCondition")));
@property (readonly) double windSpeed __attribute__((swift_name("windSpeed")));
@end
...
@interface SharedForecastItemCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForecastItemCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HourlyForecast")))
@interface SharedHourlyForecast : SharedBase
- (instancetype)initWithTime:(int64_t)time temperature:(double)temperature weatherCondition:(SharedWeatherCondition *)weatherCondition precipitationProbability:(int32_t)precipitationProbability windSpeed:(double)windSpeed humidity:(int32_t)humidity __attribute__((swift_name("init(time:temperature:weatherCondition:precipitationProbability:windSpeed:humidity:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedHourlyForecastCompanion *companion __attribute__((swift_name("companion")));
- (SharedHourlyForecast *)doCopyTime:(int64_t)time temperature:(double)temperature weatherCondition:(SharedWeatherCondition *)weatherCondition precipitationProbability:(int32_t)precipitationProbability windSpeed:(double)windSpeed humidity:(int32_t)humidity __attribute__((swift_name("doCopy(time:temperature:weatherCondition:precipitationProbability:windSpeed:humidity:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t humidity __attribute__((swift_name("humidity")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HourlyForecast.Companion")))
@interface SharedHourlyForecastCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHourlyForecastCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithId:(NSString *)id name:(NSString *)name country:(NSString *)country state:(NSString * _Nullable)state latitude:(double)latitude longitude:(double)longitude __attribute__((swift_name("init(id:name:country:state:latitude:longitude:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLocationCompanion *companion __attribute__((swift_name("companion")));
- (SharedLocation *)doCopyId:(NSString *)id name:(NSString *)name country:(NSString *)country state:(NSString * _Nullable)state latitude:(double)latitude longitude:(double)longitude __attribute__((swift_name("doCopy(id:name:country:state:latitude:longitude:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *country __attribute__((swift_name("country")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherCache")))
@interface SharedWeatherCache : SharedBase
- (instancetype)initWithLocationId:(NSString *)locationId weatherData:(NSString *)weatherData lastUpdated:(int64_t)lastUpdated expiresAt:(int64_t)expiresAt __attribute__((swift_name("init(locationId:weatherData:lastUpdated:expiresAt:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWeatherCacheCompanion *companion __attribute__((swift_name("companion")));
- (SharedWeatherCache *)doCopyLocationId:(NSString *)locationId weatherData:(NSString *)weatherData lastUpdated:(int64_t)lastUpdated expiresAt:(int64_t)expiresAt __attribute__((swift_name("doCopy(locationId:weatherData:lastUpdated:expiresAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
...
@property (readonly) NSString *locationId __attribute__((swift_name("locationId")));
@property (readonly) NSString *weatherData __attribute__((swift_name("weatherData")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherCache.Companion")))
@interface SharedWeatherCacheCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherCacheCompanion *shared __attribute__((swift_name("shared")));
- (SharedWeatherCache *)createLocationId:(NSString *)locationId weatherDataJson:(NSString *)weatherDataJson __attribute__((swift_name("create(locationId:weatherDataJson:)")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) int32_t CACHE_DURATION_MINUTES __attribute__((swift_name("CACHE_DURATION_MINUTES")));
@property (readonly) int64_t CACHE_DURATION_MS __attribute__((swift_name("CACHE_DURATION_MS")));
@end
...
@interface SharedWeatherCondition : SharedBase
- (instancetype)initWithId:(int32_t)id main:(NSString *)main description:(NSString *)description icon:(NSString *)icon __attribute__((swift_name("init(id:main:description:icon:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWeatherConditionCompanion *companion __attribute__((swift_name("companion")));
- (SharedWeatherCondition *)doCopyId:(int32_t)id main:(NSString *)main description:(NSString *)description icon:(NSString *)icon __attribute__((swift_name("doCopy(id:main:description:icon:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
...
@interface SharedWeatherConditionCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherConditionCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithLocation:(SharedLocation *)location current:(SharedCurrentWeather *)current forecast:(NSArray<SharedForecastItem *> *)forecast hourlyForecast:(NSArray<SharedHourlyForecast *> *)hourlyForecast __attribute__((swift_name("init(location:current:forecast:hourlyForecast:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWeatherDataCompanion *companion __attribute__((swift_name("companion")));
- (SharedWeatherData *)doCopyLocation:(SharedLocation *)location current:(SharedCurrentWeather *)current forecast:(NSArray<SharedForecastItem *> *)forecast hourlyForecast:(NSArray<SharedHourlyForecast *> *)hourlyForecast __attribute__((swift_name("doCopy(location:current:forecast:hourlyForecast:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedCurrentWeather *current __attribute__((swift_name("current")));
@property (readonly) NSArray<SharedForecastItem *> *forecast __attribute__((swift_name("forecast")));
@property (readonly) NSArray<SharedHourlyForecast *> *hourlyForecast __attribute__((swift_name("hourlyForecast")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWeatherDataCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@protocol SharedWeatherRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addFavoriteLocationLocation:(SharedLocation *)location completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addFavoriteLocation(location:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getCurrentWeatherLocation:(SharedLocation *)location completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getCurrentWeather(location:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getFavoriteLocationsWithCompletionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getFavoriteLocations(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getWeatherForecastLocation:(SharedLocation *)location completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getWeatherForecast(location:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)isFavoriteLocationLocationId:(NSString *)locationId completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("isFavoriteLocation(locationId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)removeFavoriteLocationLocationId:(NSString *)locationId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("removeFavoriteLocation(locationId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)searchLocationsQuery:(NSString *)query completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("searchLocations(query:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InMemoryWeatherRepository")))
@interface SharedInMemoryWeatherRepository : SharedBase <SharedWeatherRepository>
- (instancetype)initWithApiClient:(id<SharedWeatherApiClient>)apiClient __attribute__((swift_name("init(apiClient:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedInMemoryWeatherRepositoryCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InMemoryWeatherRepository.Companion")))
@interface SharedInMemoryWeatherRepositoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedInMemoryWeatherRepositoryCompanion *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiKeyProvider")))
@interface SharedApiKeyProvider : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)apiKeyProvider __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedApiKeyProvider *shared __attribute__((swift_name("shared")));
- (NSString *)getOpenWeatherApiKey __attribute__((swift_name("getOpenWeatherApiKey()")));
@end

@interface SharedCurrentWeatherResponse (Extensions)
- (SharedCurrentWeather *)toCurrentWeather __attribute__((swift_name("toCurrentWeather()")));
- (SharedWeatherData *)toWeatherDataLocation:(SharedLocation *)location __attribute__((swift_name("toWeatherData(location:)")));
@end

@interface SharedForecastResponse (Extensions)
- (NSArray<SharedForecastItem *> *)toDailyForecast __attribute__((swift_name("toDailyForecast()")));
- (NSArray<SharedHourlyForecast *> *)toHourlyForecast __attribute__((swift_name("toHourlyForecast()")));
@end

@interface SharedGeocodeResponse (Extensions)
- (SharedLocation *)toLocation __attribute__((swift_name("toLocation()")));
@end

@interface SharedWeatherResponse (Extensions)
- (SharedWeatherCondition *)toWeatherCondition __attribute__((swift_name("toWeatherCondition()")));
@end
